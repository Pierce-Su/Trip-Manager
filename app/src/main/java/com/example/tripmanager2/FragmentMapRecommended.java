...
public class FragmentMapRecommended extends Fragment {
    ...
    private OnMapReadyCallback callback = new OnMapReadyCallback() {
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            mMap.addMarker(new MarkerOptions().position(fromLatLng).title("出發點"));
        ...
        supportMapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(@NonNull GoogleMap googleMap) {
                ...
                if(lastBlock == null){
                    ...
                    frmLat = Double.parseDouble(lastBlock.lat);
                    frmLng = Double.parseDouble(lastBlock.lng);;
                }
